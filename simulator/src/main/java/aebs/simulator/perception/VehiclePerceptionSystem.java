...
public final class VehiclePerceptionSystem implements ISensorSystem {
    private RadarReading[] radarData;
    private CameraReading[] cameraData;
    private WheelSpeedReading[] wheelData;

    public VehiclePerceptionSystem(RadarReading[] radars, CameraReading[] cameras, WheelSpeedReading[] wheels) {
